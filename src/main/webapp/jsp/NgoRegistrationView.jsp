<%@page import="online.food.donation.controller.NgoRegistrationCtl"%>
...
<%@ include file="Header.jsp" %>
 <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"> <strong class="text-black">NGO Registration</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">NGO Registration</h2>
            
          </div>
          <div class="col-md-7">
			
            <form action="<%=OFDView.NGO_REGISTRATION_CTL%>" method="post">
              ...
              <div class="p-3 p-lg-5 border">
               ...
               <b><font color="green"> <%=ServletUtility.getSuccessMessage(request)%></font></b>
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    <label for="c_fname" class="text-black">Owner First Name <span class="text-danger">*</span></label>
                    <input type="text" class="form-control"  name="firstName" placeholder="Enter First Name" 
                    value="<%=DataUtility.getStringData(bean.getFirstName())%>">
                    <font color="red"> <%=ServletUtility.getErrorMessage("firstName", request)%></font>
                  </div>
                  <div class="col-md-6">
                    <label for="c_lname" class="text-black">Owner Last Name <span class="text-danger">*</span></label>
               ...
               <%--  <div class="form-group row">
                ...
                <%
                 ...
                 <div class="form-group row">
                  ...
                  <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_email" class="text-black">NGO Name<span class="text-danger">*</span></label>
                    <input type="text" class="form-control"  name="ngoname" placeholder="Enter NGO Name"
                    value="<%=DataUtility.getStringData(bean.getNgoname())%>" >
                    <font color="red"> <%=ServletUtility.getErrorMessage("ngoname", request)%></font>
                  </div>
                </div>
                
                <div class="form-group row">
                  <div class="col-lg-6">
                    <input type="submit" class="btn btn-primary btn-lg btn-block" name="operation" value="<%=NgoRegistrationCtl.OP_SIGN_UP%>">
                  </div>
                  <div class="col-lg-6">
                    <input type="submit" class="btn btn-primary btn-lg btn-block" name="operation" value="<%=NgoRegistrationCtl.OP_RESET%>">
                  </div>
                </div>
              </div>
            </form>
