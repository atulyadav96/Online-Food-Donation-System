package online.food.donation.utility;
...
import online.food.donation.controller.BaseCtl;
import online.food.donation.controller.OFDView;
...
public class ServletUtility {
	...
	public static void handleException(Exception e, HttpServletRequest request, HttpServletResponse response)
		...
		ServletUtility.forward(OFDView.ERROR_CTL, request, response);
		e.printStackTrace();
	}
